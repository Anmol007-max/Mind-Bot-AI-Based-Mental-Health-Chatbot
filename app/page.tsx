...
export default function Home() {
  const emotions = [
    ...
    { value: 25, label: "🙂 Content", color:"from-gray-500/50" },
  ...
  return (
    <div className="flex flex-col min-h-screen overflow-hidden">
      ...
      py-12 px-4">
        ...
        overflow-hidden">
          <div className={`absolute w-[500px] h-[500px] rounded-full blur-3xl top-0 -left-20 transition-all duration-700 ease-in-out
            bg-gradient-to-r ${currentEmotion.color} to-transparent opacity-60`}
          />
          <div className="absolute w-[400px] h-[400px] rounded-full bg-secondary/10
          blur-3xl bottom-0 right-0 animate-pulse
          delay-700"  />
        ...
        >
          ...
          Welcome to MindBot — your digital space for emotional healing.
          Experience a new way of therapy where AI understands your feelings and helps you find calm through intelligent, emotion-aware conversations.
          </p>
          ...
          >
            ...
            <div className="text-center">
              <p className="text-sm text-muted-foreground animate-pulse">
                ...
                And be honest if you genuinely want to be helped 😉 
              </p>
            </div>
          </motion.div>
